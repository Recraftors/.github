...
This project was launched by [Nerjal Nosk](https://github.com/NerjalNosk) at the end of 2022, and aims to bring a bunch of Minecraft mods to the universal stage, not only bringing old ones to life but also making them usable with all modloaders!
...
We aim to do mod porting as a main activity, but making our own mods will also be a thing!
Mainly, our base mod [Almanac](# "Closed source until out of developement phase"), will be at the core of all our systems, providing easily usable tools to mods run on all loaders.
...
You can suggest a mod to be ported on both out [Discord](#Our-Discord) server, or through this repo's [discussions](https://github.com/orgs/Recraftors/discussions)
...
You can also use this repo's [discussions](https://github.com/orgs/Recraftors/discussions/categories/candidate) to provide us a base candidacy sheet<!--TODO: add announcement template and provide link-->, and we would then take contact with you in order to discuss your candidacy.
